...
async function main() {
  ...
  const slaRules = [
    { urgency: UrgencyLevel.LOW, responseMinutes: 240, resolutionMinutes: 2880, escalationMinutes: 1440, description: '低优先级：4小时响应，48小时解决' },
    { urgency: UrgencyLevel.MEDIUM, responseMinutes: 120, resolutionMinutes: 1440, escalationMinutes: 720, description: '中优先级：2小时响应，24小时解决' },
    { urgency: UrgencyLevel.HIGH, responseMinutes: 60, resolutionMinutes: 480, escalationMinutes: 240, description: '高优先级：1小时响应，8小时解决' },
    { urgency: UrgencyLevel.URGENT, responseMinutes: 30, resolutionMinutes: 240, escalationMinutes: 120, description: '紧急：30分钟响应，4小时解决' },
  ];
